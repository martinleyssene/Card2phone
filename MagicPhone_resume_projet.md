...
- **Parallaxe** : les bords ne sont pas atteints correctement, à corriger (mapping géométrique inclinaison→position réelle), plus de téléportation au relâchement d'un drag (glissement progressif). Une correction est à faire: la carte se replace automatiquement vers le centre, quel que soit l'endroit où elle est déplacée. Elle revient donc au centre même quand je la déplace à un endroit où elle est toujours dans l'écran. Il faut juste qu'elle soit repoussée dans les limites quand elle sort, mais juste en restant au bord, sans replacement si elle ne sort pas du tout et un replacement juste au bord du bord le plus proche, pas au centre. Et la position "neutre" se calibre automatiquement sur l'angle du téléphone au moment où la carte apparaît (fini le bug d'angle neutre fixe à 45°).
